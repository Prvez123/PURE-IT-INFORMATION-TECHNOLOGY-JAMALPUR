...
<head>
  ...
  <title>Pure Information Engineering Training Institute</title>
...
<div class="admission-buttons">
  ...
  <div id="guideline" class="sub-section" style="display: none;">
    <h3>📋 ভর্তি নির্দেশনা</h3>
    <ul>
      <li>ন্যূনতম এসএসসি পাস হতে হবে</li>
      <li>জাতীয় পরিচয়পত্র/জন্ম সনদ প্রয়োজন</li>
      <li>এক কপি পাসপোর্ট সাইজ ছবি</li>
      <li>সরাসরি অফিসে এসে ফর্ম পূরণ করা যাবে</li>
    </ul>
  </div>

  <div id="fees" class="sub-section" style="display: none;">
    <h3>💰 কোর্স ফি</h3>
    <ul>
      <li>ওয়েব ডিজাইন: ৮,০০০ টাকা</li>
      <li>গ্রাফিক ডিজাইন: ৭,০০০ টাকা</li>
      <li>ডিজিটাল মার্কেটিং: ৬,০০০ টাকা</li>
      <li>কম্পিউটার বেসিক: ৩,০০০ টাকা</li>
    </ul>
  </div>

  <div id="form" class="sub-section" style="display: none;">
    <h3>📝 ভর্তি ফর্ম</h3>
    <form id="admissionForm">
      ...
      <label for="course">কোর্স নির্বাচন করুন:</label>
      <select id="course" name="course" required>
        <option value="">-- কোর্স নির্বাচন করুন --</option>
        <option value="web">ওয়েব ডিজাইন</option>
        <option value="graphics">গ্রাফিক ডিজাইন</option>
        <option value="marketing">ডিজিটাল মার্কেটিং</option>
        <option value="basic">কম্পিউটার বেসিক</option>
      </select>

      <label for="message">অতিরিক্ত মন্তব্য (যদি থাকে):</label>
      <textarea id="message" name="message" rows="4" placeholder="আপনার মন্তব্য"></textarea>
